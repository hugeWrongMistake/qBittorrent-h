...
peer_id myacc::lt_torrent_handle_get_peer_id(torrent_handle nativeHandle)
{
...
void myacc::lt_torrent_handle_set_peer_id(torrent_handle th, const char *strid)
{
...
void myacc::lt_torrent_handle_set_peer_id(torrent_handle th, const peer_id &id)
{
